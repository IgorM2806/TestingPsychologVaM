...
public class CheckingConsultationRequestFormsTests extends BaseTest {
    ...
    public void CheckingConsultationForms() throws InterruptedException {
        ...
        try {
            assertTrue("Раздел 'Заявка на консультацию' не отображается!", controlElement.isDisplayed());
    ...
    public void CheckingConsultationFormLabel2() throws InterruptedException {
        ...
        try {
            assertEquals("Название поля 'Email' не соответствует ожиданию!", formLabel2Element.getText(),
                    "Email");
    ...
    public void CheckingConsultationFormLabel3() throws InterruptedException {
    ...
    public void CheckingConsultationFormLabel4() throws InterruptedException {
